...
export interface ApiAboutAbout extends Schema.SingleType {
  ...
  attributes: {
    ...
    Form: Attribute.Component<'molecules.form-field', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    sendButton: Attribute.Component<'molecules.button'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiConfigConfig extends Schema.SingleType {
  ...
  attributes: {
    instagra_url: Attribute.String;
    logo: Attribute.Media<'images'>;
    logo_footer: Attribute.Media<'images'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSerieSerie extends Schema.CollectionType {
  ...
  attributes: {
    ...
    tirages: Attribute.Relation<
      ...
      'api::tirage.tirage'
    >;
    techniques: Attribute.Relation<
      'api::serie.serie',
      'manyToMany',
      'api::technique.technique'
    >;
    slug: Attribute.UID<'api::serie.serie', 'title'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiTechniqueTechnique extends Schema.CollectionType {
  ...
  attributes: {
    ...
    series: Attribute.Relation<
      ...
      'api::serie.serie'
    >;
    slug: Attribute.UID<'api::technique.technique', 'title'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiTirageTirage extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::tirage.tirage': ApiTirageTirage;
    }
  }
}
